                                ...
                                <div class="product-listing">
                                    @forelse ($products as $product)
                                        <div class="main-price">
                                            <a href="{{ url('product/'.$product->slug) }}" class="font-default">
                                            ...
                                            <h3 class="theme-color">{{ number_format($product->regular_price, 2) }} FCFA</h3>
                            ...
                            <div class="product-details">
                                <div class="rating-details">
                                    ...
                                    <ul class="rating mt-0">
                                        @for ($i = 0; $i < 5; $i++)
                                            <li>
                                                <i class="fas fa-star {{ $i < 2 ? 'theme-color' : '' }}"></i>
                                            </li>
                                        @endfor
                                    </ul>
                                </div>
                                <div class="main-price">
                                    <a href="{{ route('admin.product.show', $product->id) }}" class="font-default">
                                        <h5 class="ms-0">{{ $product->name }}</h5>
                                    </a>
                                    <div class="listing-content">
                                        @if ($product->category)
